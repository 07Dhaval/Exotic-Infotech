      ...
      packages: [
        {
          ...
          icon: "rocket",
          theme: "blue",
          bestFor: "Startups & small businesses needing basic online presence",
          features: [
            {
              icon: "share",
              title: "Social Media Management",
              items: [
                "5 Posts per month (Instagram + Facebook)",
                "2 Stories per week",
                "Basic post designs (static creatives)",
                "Caption writing with hashtags",
                "Basic engagement (reply to comments/messages)",
              ],
            },
            {
              icon: "search",
              title: "Basic SEO",
              items: [
                "Website audit (one-time, if available)",
          ...
          deliverables: [
            ...
            "Basic Google ranking improvement",
          ],
        },
        {
          name: "Growth",
          ...
          icon: "trend",
          theme: "green",
          bestFor: "Businesses that want leads, not just presence",
          features: [
            {
              icon: "search",
              title: "Advanced SEO",
              items: [
                "Keyword research (15-25 keywords)",
            ...
            {
              icon: "megaphone",
              title: "Paid Ads Management (1 Platform)",
              items: [
                "Google Ads OR Meta Ads",
                "Campaign setup & optimization",
                "Audience targeting",
                "Ad copy + creative guidance",
                "Budget optimization (ad spend paid by client separately)",
              ],
            },
            {
              icon: "users",
              ...
              items: [
                "Basic landing page (if required)",
                "Lead form integration",
                "WhatsApp lead capture setup",
                "Call tracking (basic setup)",
              ],
            },
            {
              icon: "calendar",
              title: "Monthly Strategy Call",
              items: ["Performance discussion", "Next month planning"],
            },
          ],
          deliverables: [
        ...
        },
        {
          ...
          features: [
            {
              icon: "filter",
              title: "Complete Marketing Funnel Setup",
              items: [
            ...
            {
              icon: "layers",
              title: "Multi-Platform Ads Management",
              items: [
                "Google Ads + Meta Ads",
